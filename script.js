function validateForm() {
    ...
    if (fullNameSize <= 3) {
        ...
        document.querySelector('.error_message').innerText = 'Message is required with minium 10 characters!!'

    } else {
        console.log('not matching...')
        document.querySelector('.error_message').innerText = ''
        document.querySelector('.success_message').innerText = 'Submit Successfully'
    }
